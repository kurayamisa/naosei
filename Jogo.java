...
public class Jogo {
	...
	Font Titulo = new Font("Times New Roman", Font.PLAIN, 90);
		...
		con.add(botaoContinuar); 
				...
				botaoContinuar.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent e) {	
						...
						textoLabel.setBounds(69, 98, 504, 66);
						...
						textHP.setBounds(129, 362, 118, 40);
						...
						textHPmonstro.setBounds(414, 363, 159, 40);
